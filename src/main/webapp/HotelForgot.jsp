...
<div class="container">
  ...
  <form action="forgotHotelPassword" id="forgotPasswordForm" onsubmit="return validateForm()" method="post">
  	<%String nohotel=(String)request.getAttribute("nohotel"); 
  	if(nohotel!=null){%>
  	
  	<span style="color: red"><%=nohotel %></span>
  	<%} %>
